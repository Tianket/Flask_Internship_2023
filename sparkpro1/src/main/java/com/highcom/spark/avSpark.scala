...
object avSpark {
  ...
  def dbcon(): Unit ={
    val url = "jdbc:mysql:///lindashixi?useUnicode=true&characterEncoding=UTF8&serverTimezone=UTC"
    //驱动名称
    val driver = "com.mysql.cj.jdbc.Driver"
    //用户名
    val username = "root"
    //密码
    val password = "zch001004"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rdd = sc.textFile("/Users/apple/Desktop/sparkpro1/data/advdata1.txt")
